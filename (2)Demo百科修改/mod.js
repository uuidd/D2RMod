...
// demo4 模组功能
  ...
  demo4.push(normalText('关底boss bug杀适配2.6/2.7 邪恶区域'));
  demo4.push(normalText('大幅增加 6boss 钥匙爆率，适配邪恶区域'));
  ...
  demo4.push(normalText('钥匙/书籍堆叠数量提升至100，省得频繁购买，太多开荒角色购买花费太多也不好'));
