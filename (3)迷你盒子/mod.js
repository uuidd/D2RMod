...
const hubPanelButtonsHDFilename = 'global\\ui\\layouts\\hudpanelbuttonshd.json';
let hubPanelButtonsHD = D2RMM.readJson(hubPanelButtonsHDFilename);
...
miniCubeIcon.fields.rect.x = 790;
miniCubeIcon.fields.rect.y = 180;
hubPanelButtonsHD.children.push(miniCubeIcon);


D2RMM.writeJson(hubPanelHDFilename, hubPanelHD);
D2RMM.writeJson(hubPanelButtonsHDFilename, hubPanelButtonsHD);