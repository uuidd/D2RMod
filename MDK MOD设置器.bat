chcp 936
@set ver=MDK.2023.03.22
@ECHO OFF&PUSHD %~DP0 &TITLE D2R MDK MOD 自定义设置器 By ZhangMDKRU#2129  Ver.%Ver%
...
REM ===主程序界面使用set===
REM 设置常用文件夹
set d2r_layouts=.\mods\MDK\MDK.mpq\data\global\ui\layouts
set d2r_strings=.\mods\MDK\MDK.mpq\data\local\lng\strings
set d2r_items=.\mods\MDK\MDK.mpq\data\hd\items
set d2r_items_pic=.\mods\MDK\MDK.mpq\data\hd\global\ui\items
set d2r_ui=.\mods\MDK\MDK.mpq\data\hd\ui
set d2r_excel=.\mods\MDK\MDK.mpq\data\global\excel
set d2r_sfx=.\mods\MDK\MDK.mpq\data\hd\global\sfx
set d2r_missiles=.\mods\MDK\MDK.mpq\data\hd\missiles
set objects_folder=.\mods\MDK\MDK.mpq\data\hd\objects
set global_image_folder=.\mods\MDK\MDK.mpq\data\hd\global
...
set del_travincal_hall=.\mods\MDK\MDK.mpq\data\hd\env\preset\act3\travincal\travn.json
set del_chaos_door=.\mods\MDK\MDK.mpq\data\hd\env\preset\act4\diab\entry1.json
set del_act4_lava=.\mods\MDK\MDK.mpq\data\hd\env\model\act4\lava
set del_ballair_pillars=.\\mods\MDK\MDK.mpq\data\hd\env\preset\expansion\baallair\wthrone.json

set  ver_sign=%d2r_strings%\json_db
set mod_folder=.\mods\MDK\MDK.mpq
...
if exist %install_folder% (
	...
	if "!dot_path!"=="UNKNOW" (
		...
		@echo. MOD正确安装的相对路径为 !dot_path!\mods\MDK\MDK.mpq
...
:try_to_move_folder
		@echo. 开始移动MOD目录到正确的位置，原有位置如果有重名文件夹则会更名成MDK_BACKUP
		if exist %ver_sign% (
			@ echo.	 成功检测到MOD文件，即将进行文件移动
			pause
			ren !dot_path!\mods\MDK MDK_BACKUP
			@ echo.	 旧文件夹备份完成，下一步移动文件夹
			pause
			move /Y .\mods\MDK !dot_path!\mods
			@ echo.	 移动文件夹完成，下一步复制设置器到D2R目录
			pause
			copy /Y ".\MDK MOD设置器.bat" "!dot_path!\MDK MOD设置器.bat"
			@ echo.	 复制设置器到D2R目录完成
...
REM 自动启动文件部分定义
set autorun_backup=.\mods\MDK\MDK.mpq\data\global\ui\layouts\hudwarningshd.autorun_backup.json
set autorun_off=.\mods\MDK\MDK.mpq\data\global\ui\layouts\hudwarningshd.mdk.json
set autorun_file=.\mods\MDK\MDK.mpq\data\global\ui\layouts\hudwarningshd.json
set noautorun_file=.\mods\MDK\MDK.mpq\data\global\ui\layouts\hudwarningshd.noautorun.json
set AutorunCheck=.\mods\MDK\MDK.mpq\data\hd\global\ui\AutorunCheck

REM 设置DLC1的标志目录
set dlc1_sign=.\mods\MDK\MDK.mpq\data\hd\character\enemy\cr_lancer1
set dlc1_file1=.\mods\MDK\MDK.mpq\data\hd\character\DLC1\corruptrogue1
set dlc1_file2=.\mods\MDK\MDK.mpq\data\hd\character\DLC1\lancer
set dlc1_file3=.\mods\MDK\MDK.mpq\data\hd\character\DLC1\cr_lancer1
set dlc1_file4=.\mods\MDK\MDK.mpq\data\hd\character\DLC1\act2hire.json
set dlc1_t_file1=.\mods\MDK\MDK.mpq\data\hd\character\enemy\corruptrogue1
set dlc1_t_file2=.\mods\MDK\MDK.mpq\data\hd\character\enemy\lancer
set dlc1_t_file3=.\mods\MDK\MDK.mpq\data\hd\character\enemy\cr_lancer1
set dlc1_t_file4=.\mods\MDK\MDK.mpq\data\hd\character\enemy\act2hire.json

set pause_file=%d2r_layouts%\pauselayouthd.json
set font_size=%d2r_layouts%\_profileasian.json
set rune_style=.\mods\MDK\MDK.mpq\data\hd\global\ui\items\misc\rune\zod_rune.sprite
...
REM 怀旧模式字体部分
set hj_font_fangsong=.\mods\MDK\MDK.mpq\data\local\font\chi_fangsong
set hj_font_qingyuan=.\mods\MDK\MDK.mpq\data\local\font\chi_qingyuan
set hj_font_ruixiantong=.\mods\MDK\MDK.mpq\data\local\font\chi_ruixiantong
set hj_font_youyuan=.\mods\MDK\MDK.mpq\data\local\font\chi_youyuan
set hj_font_currently=.\mods\MDK\MDK.mpq\data\local\font\chi

set hp_bar=%d2r_layouts%\hudmonsterhealthhd_mdk2nd.json
set hp_bar2=%d2r_layouts%\hudmonsterhealthhd_mdk1st.json
set color_spell=.\mods\MDK\MDK.mpq\data\hd\global\ui\color_spells
set potion_style=.\mods\MDK\MDK.mpq\data\hd\global\ui\items\misc\potion
...
set convic_off=.\mods\MDK\MDK.mpq\data\hd\overlays\common\convictionback_mdk.json
set convic_on=.\mods\MDK\MDK.mpq\data\hd\overlays\common\convictionback.json

REM 咒符统一样式标记
set unify_gc_eye_dark_sign=.\mods\MDK\MDK.mpq\data\hd\global\ui\items\misc\charm_db\gc_eye_dark.unifygcsign
set unify_gc_eye_sign=.\mods\MDK\MDK.mpq\data\hd\global\ui\items\misc\charm_db\gc_eye.unifygcsign
set unify_gc_mahua_sign=.\mods\MDK\MDK.mpq\data\hd\global\ui\items\misc\charm_db\gc_mahua.unifygcsign
set unify_gc_guilian_sign=.\mods\MDK\MDK.mpq\data\hd\global\ui\items\misc\charm_db\gc_guilian.unifygcsign

set unify_lc_lingpai_sign=.\mods\MDK\MDK.mpq\data\hd\global\ui\items\misc\charm_db\lc_lingpai.unifylcsign
set unify_lc_niujiao_sign=.\mods\MDK\MDK.mpq\data\hd\global\ui\items\misc\charm_db\lc_niujiao.unifylcsign
set unify_lc_fangta_sign=.\mods\MDK\MDK.mpq\data\hd\global\ui\items\misc\charm_db\lc_fangta.unifylcsign

set unify_sc_tuoyuan_dark_sign=.\mods\MDK\MDK.mpq\data\hd\global\ui\items\misc\charm_db\sc_tuoyuan_dark.unifylcsign
set unify_sc_tuoyuan_sign=.\mods\MDK\MDK.mpq\data\hd\global\ui\items\misc\charm_db\sc_tuoyuan.unifylcsign
set unify_sc_xuanwo_sign=.\mods\MDK\MDK.mpq\data\hd\global\ui\items\misc\charm_db\sc_xuanwo.unifylcsign
set unify_sc_yuanfu_sign=.\mods\MDK\MDK.mpq\data\hd\global\ui\items\misc\charm_db\sc_yuanfu.unifylcsign

REM 咒符样式文件
set gc_eye_dark=.\mods\MDK\MDK.mpq\data\hd\global\ui\items\misc\charm_db\charm_large_eye_dark
set gc_eye=.\mods\MDK\MDK.mpq\data\hd\global\ui\items\misc\charm_db\charm_large1_eye
set gc_mahua=.\mods\MDK\MDK.mpq\data\hd\global\ui\items\misc\charm_db\charm_large2_mahua
set gc_guilian=.\mods\MDK\MDK.mpq\data\hd\global\ui\items\misc\charm_db\charm_large3_guilian

set lc_lingpai=.\mods\MDK\MDK.mpq\data\hd\global\ui\items\misc\charm_db\charm_medium1_lingpai
set lc_niujiao=.\mods\MDK\MDK.mpq\data\hd\global\ui\items\misc\charm_db\charm_medium2_niujiao
set lc_fangta=.\mods\MDK\MDK.mpq\data\hd\global\ui\items\misc\charm_db\charm_medium3_fangta

set sc_tuoyuan_dark=.\mods\MDK\MDK.mpq\data\hd\global\ui\items\misc\charm_db\charm_small1_tuoyuan_dark
set sc_tuoyuan=.\mods\MDK\MDK.mpq\data\hd\global\ui\items\misc\charm_db\charm_small_tuoyuan
set sc_xuanwo=.\mods\MDK\MDK.mpq\data\hd\global\ui\items\misc\charm_db\charm_small2_xuanwo
set sc_yuanfu=.\mods\MDK\MDK.mpq\data\hd\global\ui\items\misc\charm_db\charm_small3_yuanfu
...
set entry_guider=.\mods\MDK\MDK.mpq\data\hd\roomtiles_mdk
set entry_guider_c=.\mods\MDK\MDK.mpq\data\hd\roomtiles_c
...
set player_light=.\mods\MDK\MDK.mpq\data\hd\character\player
set cain_light=.\mods\MDK\MDK.mpq\data\hd\character\npc\cain1.json
set shrines_light=%objects_folder%\shrines_other

set guangyuan_u=.\mods\MDK\MDK.mpq\data\hd\character\guangyuan_u.lightsign
set guangyuan_d=.\mods\MDK\MDK.mpq\data\hd\character\guangyuan_d.lightsign
set guangyuan_n=.\mods\MDK\MDK.mpq\data\hd\character\guangyuan_n.lightsign
...
set BO_time=.\mods\MDK\MDK.mpq\data\hd\overlays\common\shield_bo\battleorders.json
set BO_time_charge=.\mods\MDK\MDK.mpq\data\hd\overlays\common\charge_bo\battleorders.json
set ass_charge_large=.\mods\MDK\MDK.mpq\data\hd\overlays\common\charge_ass_large\progressive_other_1.json
set ass_charge_large_down=.\mods\MDK\MDK.mpq\data\hd\overlays\common\charge_ass_large_down\progressive_other_1.json
set ass_charge_small=.\mods\MDK\MDK.mpq\data\hd\overlays\common\charge_ass_small\progressive_other_1.json
set ass_charge_default=.\mods\MDK\MDK.mpq\data\hd\overlays\common\progressive_other_1.json

REM===怪物脚底光源===
set enemy_nolight=.\mods\MDK\MDK.mpq\data\hd\character\nolight.enemysign
set enemy_light_1=.\mods\MDK\MDK.mpq\data\hd\character\light_1.enemysign
set enemy_light_2=.\mods\MDK\MDK.mpq\data\hd\character\light_2.enemysign
set enemy_light_3=.\mods\MDK\MDK.mpq\data\hd\character\light_3.enemysign
set enemy_nosign=.\mods\MDK\MDK.mpq\data\hd\character\nosign.enemysign
...
set function_btn=.\mods\MDK\MDK.mpq\data\hd\global\ui\mdk\mdk
...
set sor_es_aura=.\mods\MDK\MDK.mpq\data\hd\overlays\sorceress\energyshield.json
...
set mini_map_unit=.\mods\MDK\MDK.mpq\data\hd\global\ui\automap\units.sprite
set mini_map_unit_mdk=.\mods\MDK\MDK.mpq\data\hd\global\ui\automap\units_mdk.sprite
set mini_map_unit_low=.\mods\MDK\MDK.mpq\data\hd\global\ui\automap\units.lowend.sprite
set mini_map_unit_low_mdk=.\mods\MDK\MDK.mpq\data\hd\global\ui\automap\units_mdk.lowend.sprite

REM 切换共享箱子存档用
set d2r_save=%USERPROFILE%\Saved Games\Diablo II Resurrected
set c_save_sign=.\mods\MDK\MDK.mpq\current_sharebox.shareboxsign
...
REM 刺客聚气图标
set ass_charge_up=.\mods\MDK\MDK.mpq\data\hd\overlays\common\progressive_damage_3.json
set ass_charge_missiles=.\mods\MDK\MDK.mpq\data\hd\missiles\missiles.json

REM ===规则设置界面使用set===
set rule_addr=%d2r_strings%\json_db\rule

REM ===规则文件组成部分定义===
set NoDropCheck=.\mods\MDK\MDK.mpq\data\hd\global\ui\DropFilter
...
set target_hp_color=.\mods\MDK\MDK.mpq\data\hd\global\ui\panel\hud_02\healthmanaanimation\healthidle\4k\globe_color_hp.sprite
set target_mp_color=.\mods\MDK\MDK.mpq\data\hd\global\ui\panel\hud_02\healthmanaanimation\healthidle\4k\globe_color_mp.sprite
...
REM @ echo.　　               ┃                                  Ver.%Ver%        ┃
REM @ echo.                   ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛
@ echo.	━━━━━━━━━━┃D2R MDK MOD 自定义设置器 By ZhangMDKRU#2129  Ver.%Ver%┃━━━━━━━━━━
@ echo.				 
...
:set_del_travincal_hall
	...
	ren .\mods\MDK\MDK.mpq\data\hd\env\preset\act3\travincal\travn.json travn_mdk.json
	ren .\mods\MDK\MDK.mpq\data\hd\env\preset\act3\travincal\travsw.json travsw_mdk.json
	) else (
	@ echo.		 ┣  输入【H】 选择【屏蔽崔凡客议会大厅的墙壁与外围立柱 ×】  
	ren .\mods\MDK\MDK.mpq\data\hd\env\preset\act3\travincal\travn_mdk.json travn.json
	ren .\mods\MDK\MDK.mpq\data\hd\env\preset\act3\travincal\travsw_mdk.json travsw.json
	)
Goto FunctionEnd
:set_del_chaos_door
	if exist %del_chaos_door% (
	@ echo.		 ┣  输入【J】 选择【屏蔽混沌避难所大门 √】 
	ren .\mods\MDK\MDK.mpq\data\hd\env\preset\act4\diab\entry1.json entry1_mdk.json
	) else (
	@ echo.		 ┣  输入【J】 选择【屏蔽混沌避难所大门 ×】 
	ren .\mods\MDK\MDK.mpq\data\hd\env\preset\act4\diab\entry1_mdk.json entry1.json
	)
Goto FunctionEnd
:set_del_act4_lava
	if exist %del_act4_lava% (
		@ echo.		 ┣  输入【K】 选择【屏蔽火焰之河的岩浆 √】 
		ren .\mods\MDK\MDK.mpq\data\hd\env\model\act4\lava lava_mdk
		del .\mods\MDK\MDK.mpq\data\hd\objects\vfx_only\hell_smoke.json
		del .\mods\MDK\MDK.mpq\data\hd\objects\vfx_only\hellfire_1.json
		del .\mods\MDK\MDK.mpq\data\hd\objects\vfx_only\hellfire_2.json
		del .\mods\MDK\MDK.mpq\data\hd\objects\vfx_only\hellfire_3.json
	) else (
	@ echo.		 ┣  输入【K】 选择【屏蔽火焰之河的岩浆 ×】 
		ren .\mods\MDK\MDK.mpq\data\hd\env\model\act4\lava_mdk lava
		copy /Y .\mods\MDK\MDK.mpq\data\hd\objects\vfx_only\mdk\hell_smoke.json .\mods\MDK\MDK.mpq\data\hd\objects\vfx_only
		copy /Y .\mods\MDK\MDK.mpq\data\hd\objects\vfx_only\mdk\hellfire_1.json .\mods\MDK\MDK.mpq\data\hd\objects\vfx_only
		copy /Y .\mods\MDK\MDK.mpq\data\hd\objects\vfx_only\mdk\hellfire_2.json .\mods\MDK\MDK.mpq\data\hd\objects\vfx_only
		copy /Y .\mods\MDK\MDK.mpq\data\hd\objects\vfx_only\mdk\hellfire_3.json .\mods\MDK\MDK.mpq\data\hd\objects\vfx_only
	)
Goto FunctionEnd
:set_del_ballair_pillars
	if exist %del_ballair_pillars% (
	@ echo.		 ┗  输入【L】 选择【屏蔽巴尔王座中的立柱与竖旗 √】
	ren .\mods\MDK\MDK.mpq\data\hd\env\preset\expansion\baallair\wthrone.json wthrone_mdk.json
	) else (
	@ echo.		 ┗  输入【L】 选择【屏蔽巴尔王座中的立柱与竖旗 ×】
	ren .\mods\MDK\MDK.mpq\data\hd\env\preset\expansion\baallair\wthrone_mdk.json wthrone.json
	) 
Goto FunctionEnd
...
if exist %player_light% (
@ echo.	 设置 【关闭全图光源】  
ren .\mods\MDK\MDK.mpq\data\hd\character\player player_mu
) else (
@ echo.	 设置 【开启全图光源】  
ren .\mods\MDK\MDK.mpq\data\hd\character\player_mu player
)
Goto FunctionEnd
...
if exist %function_btn% (
@ echo.	 设置 【关闭虚空按键功能】  
ren .\mods\MDK\MDK.mpq\data\hd\global\ui\mdk\mdk mdk_btn
) else (
@ echo.	 设置 【开启虚空按键功能】  
ren .\mods\MDK\MDK.mpq\data\hd\global\ui\mdk\mdk_btn mdk
)
goto FunctionEnd
...
:set_no_mark_mode
del .\mods\MDK\MDK.mpq\data\hd\character\enemy\*.json
del .\mods\MDK\MDK.mpq\data\hd\character\*.enemysign
@ECHO.  "x">%enemy_nosign%
goto FunctionEnd

:set_only_rune_mark_mode
del .\mods\MDK\MDK.mpq\data\hd\character\enemy\*.json
copy /Y .\mods\MDK\MDK.mpq\data\hd\character\enemy_nolight\*.json .\mods\MDK\MDK.mpq\data\hd\character\enemy
del .\mods\MDK\MDK.mpq\data\hd\character\*.enemysign
...
:set_light_mark_mode
del .\mods\MDK\MDK.mpq\data\hd\character\enemy\*.json
copy /Y .\mods\MDK\MDK.mpq\data\hd\character\enemy_light_2\*.json .\mods\MDK\MDK.mpq\data\hd\character\enemy
del .\mods\MDK\MDK.mpq\data\hd\character\*.enemysign
...
del .\mods\MDK\MDK.mpq\data\hd\character\enemy\*.json
copy /Y .\mods\MDK\MDK.mpq\data\hd\character\enemy_light_1\*.json .\mods\MDK\MDK.mpq\data\hd\character\enemy
del .\mods\MDK\MDK.mpq\data\hd\character\*.enemysign
...
:雷光标记模式
del .\mods\MDK\MDK.mpq\data\hd\character\enemy\*.json
copy /Y .\mods\MDK\MDK.mpq\data\hd\character\enemy_light_3\*.json .\mods\MDK\MDK.mpq\data\hd\character\enemy
del .\mods\MDK\MDK.mpq\data\hd\character\*.enemysign
...
move /Y mods\MDK\MDK.mpq\data\hd\objects\destructibles\*.json mods\MDK\MDK.mpq\data\hd\objects\destructibles\mdk
move /Y mods\MDK\MDK.mpq\data\hd\objects\destructibles\mdk\barrel_exploding.json mods\MDK\MDK.mpq\data\hd\objects\destructibles
move /Y mods\MDK\MDK.mpq\data\hd\objects\destructibles\mdk\exploding_chest_100.json mods\MDK\MDK.mpq\data\hd\objects\destructibles
move /Y mods\MDK\MDK.mpq\data\hd\objects\destructibles\mdk\ice_cave_evil_urn.json mods\MDK\MDK.mpq\data\hd\objects\destructibles

) else (
@ echo.	 设置 【开启可踢坏物品发光并追加光源】  
move /Y mods\MDK\MDK.mpq\data\hd\objects\destructibles\mdk\*.json mods\MDK\MDK.mpq\data\hd\objects\destructibles
)
...
move /Y mods\MDK\MDK.mpq\data\hd\objects\env_manmade\*.json mods\MDK\MDK.mpq\data\hd\objects\env_manmade\mdk
ren %objects_folder%\env_manmade\soul_stone_forge.mdkjson soul_stone_forge.json
ren %objects_folder%\doors doors_mdk
ren %objects_folder%\shrines_healthmana shrines_healthmana_mdk
ren %objects_folder%\shrines_other shrines_other_mdk
ren %objects_folder%\wells wells_mdk
del .\mods\MDK\MDK.mpq\data\hd\character\enemy\act2hire.json
del .\mods\MDK\MDK.mpq\data\hd\character\enemy\act3hire.json
del .\mods\MDK\MDK.mpq\data\hd\character\enemy\act5hire1.json
del .\mods\MDK\MDK.mpq\data\hd\character\enemy\roguehire.json
) else (
@ echo.	 设置 【开启神坛、场景物品与门的追加光源】  
move /Y mods\MDK\MDK.mpq\data\hd\objects\env_manmade\mdk\*.json mods\MDK\MDK.mpq\data\hd\objects\env_manmade
ren %objects_folder%\doors_mdk doors
ren %objects_folder%\shrines_healthmana_mdk shrines_healthmana
ren %objects_folder%\shrines_other_mdk shrines_other
ren %objects_folder%\wells_mdk wells
copy /Y .\mods\MDK\MDK.mpq\data\hd\character\hirelight_mu\*.json .\mods\MDK\MDK.mpq\data\hd\character\enemy
)
goto FunctionEnd
...
@ echo.	 设置 【关闭光源】 
del .\mods\MDK\MDK.mpq\data\hd\character\*.lightsign
del .\mods\MDK\MDK.mpq\data\hd\character\player\*.json
@ECHO.  "x">%guangyuan_n%
...
del .\mods\MDK\MDK.mpq\data\hd\character\*.lightsign
del .\mods\MDK\MDK.mpq\data\hd\character\player\*.json
copy /Y .\mods\MDK\MDK.mpq\data\hd\character\player_mu\*.json .\mods\MDK\MDK.mpq\data\hd\character\player
@ECHO.  "x">%guangyuan_u%
...
del .\mods\MDK\MDK.mpq\data\hd\character\*.lightsign
del .\mods\MDK\MDK.mpq\data\hd\character\player\*.json
copy /Y .\mods\MDK\MDK.mpq\data\hd\character\player_md\*.json .\mods\MDK\MDK.mpq\data\hd\character\player
copy /Y .\mods\MDK\MDK.mpq\data\hd\character\player_md\*.json .\mods\MDK\MDK.mpq\data\hd\character\player
@ECHO.  "x">%guangyuan_d%
) else (
del .\mods\MDK\MDK.mpq\data\hd\character\*.lightsign
...
if exist %wp_guider% (
@ echo.	 设置 【关闭传送点光柱引导】  
move /Y mods\MDK\MDK.mpq\data\hd\objects\waypoint_portals mods\MDK\MDK.mpq\data\hd\objects\waypoint_portals_mdk
) else (
@ echo.	 设置 【打开传送点光柱引导】  
move /Y mods\MDK\MDK.mpq\data\hd\objects\waypoint_portals_mdk mods\MDK\MDK.mpq\data\hd\objects\waypoint_portals
)
goto FunctionEnd
...
if not exist %entry_guider% (
	@ echo.	  设置 【切换成紫圈混合】
	ren .\mods\MDK\MDK.mpq\data\hd\roomtiles roomtiles_mdk
	ren .\mods\MDK\MDK.mpq\data\hd\roomtiles_c roomtiles
	...
	ren .\mods\MDK\MDK.mpq\data\hd\roomtiles roomtiles_c
	...
	ren .\mods\MDK\MDK.mpq\data\hd\env\model\expansion\siege\expansion_siege_hellportals\pf_hell_portal_n01.json pf_hell_portal_n01_mdk.json
	ren .\mods\MDK\MDK.mpq\data\hd\env\model\expansion\siege\expansion_siege_hellportals\pf_hell_portal_w01.json pf_hell_portal_w01_mdk.json
	ren .\mods\MDK\MDK.mpq\data\hd\env\model\act3\jungle\prefab\pf_jungle_totem_d_foliage01.json pf_jungle_totem_d_foliage01_mdk.json
) else (
	@ echo.	  设置 【打开入口光柱引导】
	ren .\mods\MDK\MDK.mpq\data\hd\roomtiles_mdk roomtiles
	...
	ren .\mods\MDK\MDK.mpq\data\hd\env\model\expansion\siege\expansion_siege_hellportals\pf_hell_portal_n01_mdk.json pf_hell_portal_n01.json
	ren .\mods\MDK\MDK.mpq\data\hd\env\model\expansion\siege\expansion_siege_hellportals\pf_hell_portal_w01_mdk.json pf_hell_portal_w01.json
	ren .\mods\MDK\MDK.mpq\data\hd\env\model\act3\jungle\prefab\pf_jungle_totem_d_foliage01_mdk.json pf_jungle_totem_d_foliage01.json
)
goto FunctionEnd
...
move /Y mods\MDK\MDK.mpq\data\hd\objects\armor_weapons\*.json mods\MDK\MDK.mpq\data\hd\objects\armor_weapons\mdk
...
move /Y mods\MDK\MDK.mpq\data\hd\objects\characters\mdk\*.* mods\MDK\MDK.mpq\data\hd\objects\characters
move /Y mods\MDK\MDK.mpq\data\hd\objects\armor_weapons\mdk\*.json mods\MDK\MDK.mpq\data\hd\objects\armor_weapons
...
move /Y mods\MDK\MDK.mpq\data\hd\items\misc\gem mods\MDK\MDK.mpq\data\hd\items\misc\gem_all
move /Y mods\MDK\MDK.mpq\data\hd\items\misc\gem_high mods\MDK\MDK.mpq\data\hd\items\misc\gem
) else if not exist %high_gem% (
@ echo.   【关闭宝石光柱效果】 正在处理中...请稍等...
move /Y mods\MDK\MDK.mpq\data\hd\items\misc\gem mods\MDK\MDK.mpq\data\hd\items\misc\gem_high
move /Y mods\MDK\MDK.mpq\data\hd\items\misc\gem_nolight mods\MDK\MDK.mpq\data\hd\items\misc\gem
) else (
@ echo.   【增加所有等级宝石光柱效果】 正在处理中...请稍等...
move /Y mods\MDK\MDK.mpq\data\hd\items\misc\gem mods\MDK\MDK.mpq\data\hd\items\misc\gem_nolight
move /Y mods\MDK\MDK.mpq\data\hd\items\misc\gem_all mods\MDK\MDK.mpq\data\hd\items\misc\gem
)
goto FunctionEnd
...
REM @ echo.         ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛
@ echo.		━━━━━━━━━━┃D2R MDK MOD 屏蔽显示规则设置器 By ZhangMDKRU#2129┃━━━━━━━━━━
@ echo.		
@ echo.	 ※※※三个语言版本屏蔽配置文件相互独立，切换后请重新设置屏蔽配置※※※
if not exist %lang_zhTW_cht% (
...
@ echo.	
REM @ echo.         ┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
REM @ echo.　　     ┃        D2R MDK MOD 游戏音效设置器 By ZhangMDKRU#2129       ┃
REM @ echo.         ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛
@ echo.		━━━━━━━━━━┃D2R MDK MOD 游戏音效设置器 By ZhangMDKRU#2129┃━━━━━━━━━━
@ echo.				 
...
@ echo.	 输入【DLC1】切换，DLC 1【白色堕落萝格风格沙漠雇佣兵】 状态：未激活
xcopy .\mods\MDK\MDK.mpq\data\hd\character\DLC1 .\mods\MDK\MDK.mpq\data\hd\character\enemy /Y /S /E
)
goto RuneSound_Main
...
@ echo.	
REM @ echo.         ┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
REM @ echo.　　     ┃         D2R MDK MOD 游戏风格设置器 By ZhangMDKRU#2129      ┃
REM @ echo.         ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛
REM call :cgreen " ━━━━━━━━━━┃D2R MDK MOD 游戏风格设置器 By ZhangMDKRU#2129┃━━━━━━━━━━"
@ echo.		━━━━━━━━━━┃D2R MDK MOD 游戏风格设置器 By ZhangMDKRU#2129┃━━━━━━━━━━
@ echo.	
...
@ echo.	 当前状态【小地图图标：MDK实心风格】		输入【E】 设置 【原版风格】
) else (
@ echo.	 当前状态【小地图图标：原版风格】		输入【E】 设置 【MDK实心风格】
)
...
ren .\mods\MDK\MDK.mpq\data\hd\character\npc npc_mdk
...
@ echo.	 设置 【增加特效提示】
ren .\mods\MDK\MDK.mpq\data\hd\overlays\sorceress\energyshield_mdk.json energyshield.json
)
...
:get_sharebox_num
	...
	for /L %%i in (1,1,9) do (
		if not exist "%d2r_save%\SharedStashSoftCoreV2_%%~i.d2i" (
			copy /Y .\mods\MDK\MDK.mpq\SharedStashSoftCoreV2_7box.d2i "%d2r_save%\SharedStashSoftCoreV2_%%~i.d2i"
		)
	)
	REM 读取标志文件第一行内容赋值
...
if not exist %offline_fullhire%  (
	...
	ren .\mods\MDK\MDK.mpq\data\hd\global\ui\panel\hireling hireling_full
	...
	ren .\mods\MDK\MDK.mpq\data\hd\global\ui\panel\hireling_full hireling
...
if not exist %ass_charge_default% (
	@ echo.	 设置 【身边显示大聚气图标】
	move .\mods\MDK\MDK.mpq\data\hd\overlays\common\charge_ass_large\progressive*.json .\mods\MDK\MDK.mpq\data\hd\overlays\common\

	del .\mods\MDK\MDK.mpq\data\hd\vfx\textures\graphic\progressive*.*
	copy /Y .\mods\MDK\MDK.mpq\data\hd\vfx\textures\graphic\ass_charge_large\progressive*.* .\mods\MDK\MDK.mpq\data\hd\vfx\textures\graphic\
	xcopy /Y /E .\mods\MDK\MDK.mpq\data\hd\vfx\particles\overlays\common\ass_charge_large\progressive* .\mods\MDK\MDK.mpq\data\hd\vfx\particles\overlays\common\

) else if not exist %ass_charge_large% (
	@ echo.	 设置 【UI显示大聚气图标】
	move .\mods\MDK\MDK.mpq\data\hd\overlays\common\progressive*.json .\mods\MDK\MDK.mpq\data\hd\overlays\common\charge_ass_large\
	move .\mods\MDK\MDK.mpq\data\hd\overlays\common\charge_ass_large_down\progressive*.json .\mods\MDK\MDK.mpq\data\hd\overlays\common\
	...
	@ echo.	 设置 【脚下显示小聚气图标】
	move .\mods\MDK\MDK.mpq\data\hd\overlays\common\progressive*.json .\mods\MDK\MDK.mpq\data\hd\overlays\common\charge_ass_large_down\
	move .\mods\MDK\MDK.mpq\data\hd\overlays\common\charge_ass_small\progressive*.json .\mods\MDK\MDK.mpq\data\hd\overlays\common\

	del .\mods\MDK\MDK.mpq\data\hd\vfx\textures\graphic\progressive*.*
	copy /Y .\mods\MDK\MDK.mpq\data\hd\vfx\textures\graphic\ass_charge_small\progressive*.* .\mods\MDK\MDK.mpq\data\hd\vfx\textures\graphic\
	xcopy /Y /E .\mods\MDK\MDK.mpq\data\hd\vfx\particles\overlays\common\ass_charge_small\progressive* .\mods\MDK\MDK.mpq\data\hd\vfx\particles\overlays\common\

) else (
	@ echo.	 设置 【不显示聚气等级图标】
	move .\mods\MDK\MDK.mpq\data\hd\overlays\common\progressive*.json .\mods\MDK\MDK.mpq\data\hd\overlays\common\charge_ass_small\
)
...
if exist %ass_charge_missiles% (
@ echo.	 设置 【恢复原版样式】
del .\mods\MDK\MDK.mpq\data\hd\missiles\missiles.json
) else (
@ echo.	 设置 【降低聚气特效】
copy /Y .\mods\MDK\MDK.mpq\data\hd\missiles\assassin_charge\missiles.json .\mods\MDK\MDK.mpq\data\hd\missiles
)
goto GameStyleFunctionEnd

:open_ass_charge_missiles_file
notepad .\mods\MDK\MDK.mpq\data\hd\missiles\missiles.json
goto GameStyleFunctionEnd
...
:set_BO_effects
	...
	if not exist %BO_time% (
	@ echo.	 设置 【显示聚气环的特效】
	move /Y mods\MDK\MDK.mpq\data\hd\overlays\common\battlecommand.json mods\MDK\MDK.mpq\data\hd\overlays\common\shield_bo
	move /Y mods\MDK\MDK.mpq\data\hd\overlays\common\battleorders.json mods\MDK\MDK.mpq\data\hd\overlays\common\shield_bo
	move /Y mods\MDK\MDK.mpq\data\hd\overlays\common\shout.json mods\MDK\MDK.mpq\data\hd\overlays\common\shield_bo
	
	move /Y mods\MDK\MDK.mpq\data\hd\overlays\common\charge_bo\battlecommand.json mods\MDK\MDK.mpq\data\hd\overlays\common
	move /Y mods\MDK\MDK.mpq\data\hd\overlays\common\charge_bo\battleorders.json mods\MDK\MDK.mpq\data\hd\overlays\common
	move /Y mods\MDK\MDK.mpq\data\hd\overlays\common\charge_bo\shout.json mods\MDK\MDK.mpq\data\hd\overlays\common
	) else if not exist %BO_time_charge% (
	@ echo.	 设置 【关闭BC/BO的BUFF特效】
	move /Y mods\MDK\MDK.mpq\data\hd\overlays\common\battlecommand.json mods\MDK\MDK.mpq\data\hd\overlays\common\charge_bo
	move /Y mods\MDK\MDK.mpq\data\hd\overlays\common\battleorders.json mods\MDK\MDK.mpq\data\hd\overlays\common\charge_bo
	move /Y mods\MDK\MDK.mpq\data\hd\overlays\common\shout.json mods\MDK\MDK.mpq\data\hd\overlays\common\charge_bo
	) else (
	@ echo.	 设置 【显示巴尔环的特效】 
	move /Y mods\MDK\MDK.mpq\data\hd\overlays\common\shield_bo\battlecommand.json mods\MDK\MDK.mpq\data\hd\overlays\common
	move /Y mods\MDK\MDK.mpq\data\hd\overlays\common\shield_bo\battleorders.json mods\MDK\MDK.mpq\data\hd\overlays\common
	move /Y mods\MDK\MDK.mpq\data\hd\overlays\common\shield_bo\shout.json mods\MDK\MDK.mpq\data\hd\overlays\common
	)
goto GameStyleFunctionEnd
...
@ echo.
	...
	move /Y mods\MDK\MDK.mpq\data\hd\global\ui\items\misc\rune mods\MDK\MDK.mpq\data\hd\global\ui\items\misc\rune_new
	) else (
	ECHO  【改为带编号符文样式】 正在处理中...请稍等...
	move /Y mods\MDK\MDK.mpq\data\hd\global\ui\items\misc\rune_new mods\MDK\MDK.mpq\data\hd\global\ui\items\misc\rune
	)
goto GameStyleFunctionEnd
...
:set_skill_icons_style
	...
	ren mods\MDK\MDK.mpq\data\hd\global\ui\color_spells spells
	) else (
	@ echo.   【原版风格技能图标】 正在处理中...请稍等...
	ren mods\MDK\MDK.mpq\data\hd\global\ui\spells color_spells
	)
goto GameStyleFunctionEnd
...
:set_potion_style
	...
	move /Y mods\MDK\MDK.mpq\data\hd\global\ui\items\misc\potion mods\MDK\MDK.mpq\data\hd\global\ui\items\misc\potion_mdk
	) else (
	@ echo.	 【设置成大圆瓶的超大红蓝瓶】 正在处理中...请稍等...
	move /Y mods\MDK\MDK.mpq\data\hd\global\ui\items\misc\potion_mdk mods\MDK\MDK.mpq\data\hd\global\ui\items\misc\potion
	)
goto GameStyleFunctionEnd
