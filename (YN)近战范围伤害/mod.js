...
missiles.rows.push({
  ...
  Activate: 0,
  LoopAnim: 0,
  // this doesn't show anything in classic graphics mode
  ...
  entities: [
    {
      type: 'Entity',
      name: 'entity_root',
      id: 2527807554 + 1, //  how to get a unique ID here?
      components: [
        {
    ...
    },
    {
      type: 'Entity',
      name: 'entity_vfx1',
      id: 3060251343 + 1, // how to get a unique ID here?
      components: [
        {
...
//  option to randomly spawn affixed on weapons
//  option to add affix to select unique / set / runeword weapons (that are intended for melee damage dealers)
